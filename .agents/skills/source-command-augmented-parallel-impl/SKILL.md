---
name: "source-command-augmented-parallel-impl"
description: "체크포인트 후 git worktree로 복수 구현 동시 진행. 불확실한 접근법 시 호출."
---

# source-command-augmented-parallel-impl

Use this skill when the user asks to run the migrated source command `augmented-parallel-impl`.
