---
name: "source-command-augmented-refinement-loop"
description: "반복적 개선 패스로 레이어별 노이즈 제거. 리팩토링/품질 개선 시 호출."
---

# source-command-augmented-refinement-loop

Use this skill when the user asks to run the migrated source command `augmented-refinement-loop`.
