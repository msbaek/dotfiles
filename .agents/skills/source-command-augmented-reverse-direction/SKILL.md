---
name: "source-command-augmented-reverse-direction"
description: "대화 방향 전환 - AI에게 제안/질문 역할 위임. 의사결정 막힐 때 호출."
---

# source-command-augmented-reverse-direction

Use this skill when the user asks to run the migrated source command `augmented-reverse-direction`.
...
- **연관**: Active Partner (AGENTS.md), `/augmented:cast-wide`
