...
| `databricks-Codex-opus-4-6` | Anthropic | Most capable, 1M context |
| `databricks-Codex-sonnet-4-6` | Anthropic | Hybrid reasoning |
| `databricks-Codex-sonnet-4-5` | Anthropic | Hybrid reasoning |
| `databricks-Codex-opus-4-5` | Anthropic | Deep analysis, 200K context |
| `databricks-Codex-sonnet-4` | Anthropic | Hybrid reasoning |
| `databricks-Codex-opus-4-1` | Anthropic | 200K context, 32K output |
| `databricks-Codex-haiku-4-5` | Anthropic | Fastest, cost-effective |
| `databricks-Codex-3-7-sonnet` | Anthropic | Retiring April 2026 |
