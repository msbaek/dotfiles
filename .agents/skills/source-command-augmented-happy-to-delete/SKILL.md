---
name: "source-command-augmented-happy-to-delete"
description: "AI 코드 폐기 결정 지원. 구현이 꼬였을 때 revert 후 재시도 가이드."
---

# source-command-augmented-happy-to-delete

Use this skill when the user asks to run the migrated source command `augmented-happy-to-delete`.
