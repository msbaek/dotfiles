...
npm "az.dev"
npm "ccusage"
npm "claude-code-watcher"
npm "claude-task-viewer"
npm "cz-emoji-conventional"
npm "cz-emoji"
...
# --- preserved: brew bundle dump (Homebrew 6.x) drops these still-installed tap formulae ---
