...
vim.keymap.set("i", "kk", "<ESC>", { desc = "[P]Exit insert mode with kj" })
...
vim.keymap.set({ "n", "v", "i" }, "<C-e>", function()
  ...
  if pasted_image then
    ...
    Snacks.image.buf.clear()
    -- vim.cmd([[lua Snacks.image.buf.clear()]])
    -- Reloads the file to reflect the changes
    vim.cmd("edit!")
...
vim.keymap.set("n", "<leader>mslk", function()
  vim.opt.spelllang = "ko"
  vim.cmd("echo 'Spell language set to Korean'")
end, { desc = "[P]Spelling language Korean" })
...
vim.keymap.set("n", "<leader>mslc", function()
  vim.opt.spelllang = "en,ko"
  vim.cmd("echo 'Spell language set to Korean and English'")
...
vim.keymap.set({ "n" }, "<leader>zn", "<cmd>ObsidianNewFromTemplate<CR>", { desc = "new from template", remap = true })
...
vim.keymap.set({ "n" }, "<leader>zr", "<cmd>ObsidianRename<CR>", { desc = "rename", remap = true })
vim.keymap.set({ "n" }, "<leader>zs", "<cmd>ObsidianSearch<CR>", { desc = "search", remap = true })
vim.keymap.set({ "n" }, "<leader>zc", "<cmd>ObsidianTOC<CR>", { desc = "TOC", remap = true })
vim.keymap.set({ "n" }, "<leader>zx", "<cmd>ObsidianToggleCheckbox<CR>", { desc = "toggle checkbox", remap = true })
